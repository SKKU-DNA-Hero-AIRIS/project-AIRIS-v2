...
- D의 패치 밀도: 캡슐 모델은 최적화 400/m²(약 1,000개), **메시 모델은 최적화 1,500/m²**(약 2,600개; 2026-09-21 총괄 결정 — 400/m²에서는 같은 자세 점수가 밀도에 따라 ±10~16% 흔들리고 1,500부터 수렴), 재채점은 둘 다 2,000/m². 1회 평가 중앙값(저부하) 캡슐 30 ms, 메시(1,500/m²) 100 ms 이하가 기준 (`docs/mesh_transition.md` 7).
